...
大病院の診療予約を Web（スマホ・PC）から簡単に行えるようにする。
電話・窓口の負担を減らし、患者が 3〜5 ステップで予約完了できる UX を提供する。
...
| UI/UX | 3〜5 ステップで予約完了。フォント 16px 以上。レスポンシブ（スマホ・タブレット・PC） |
| レスポンシブ | スマホ（〜767px）: 1 カラム縦積み。タブレット（768〜1023px）: 適宜 2 カラム。PC（1024px〜）: サイドバー付き or ワイドカラムレイアウト |
